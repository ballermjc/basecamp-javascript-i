...
// CODE HERE
var wildNameReturn = word => "wild " + word;
...
// CODE HERE
var animalSounds = (name, sound, callback) => "I am " + wildNameReturn(name) + ". Hear me " + sound + ".";
// CALLBACKS
...
var shortNames = friends.filter(function(item) {
...
// CODE HERE
var plusThree = numbers.map(function(item){
  return item + 3;
});
